...
type Account struct {//one per user account, accountId is encrypted and used to send more queries
  ...
  //perhaps add an array of champmasteries? and more later
...
func main(){
  ...
  var linkP3 = ".api.riotgames.com/lol/champion-mastery/v4/champion-masteries/by-summoner/"
    ...
    //https://na1.api.riotgames.com/lol/champion-mastery/v4/champion-masteries/by-summoner/ <summonerId>  ?api_key=  <key>
  ...
  for i := 0; i < 20; i++{//sends new set of requests every 5 min, 10 times(for now, can be any number)
      //fmt.Println(strings.Join(link1, ""))
      ...
      //fmt.Println(strings.Join(link2, ""))
...
//func getMastery(user Account) (champMastery, error){
//  //get champ masteries of account
//  return
//}
